...
response = requests.get('https://api.telegram.org/bot979730092:AAEFIhVOVVnZE-3IfQVQ_nZLchSP_AeA0DE/getUpdates')
res_dict = response.json()
chat_id = str(res_dict['result'][0]['message']['chat']['id'])

# (2) url을 조합하여 request로 요청 보내기
token = 'bot979730092:AAEFIhVOVVnZE-3IfQVQ_nZLchSP_AeA0DE'
